...
from SanzyDev import Sanzy, CMD_LIST



def Sanzy_cmd(pattern=None, command=None, **args):
...
def command(**args):
    ...
    def decorator(func):
        ...
        if allow_edited_updates:
            Sanzy.add_event_handler(func, events.MessageEdited(**args))
        Sanzy.add_event_handler(func, events.NewMessage(**args))
    ...
    def decorator(func):
        async def wrapper(check):
            ...
            try:
                ...
                if not disable_errors:
                    ...
                    text = "**✘ SANZY-USERBOT ERROR REPORT ✘**\n\n"
                    link = "[Group Support](https://t.me/SanzyChats)"
                    ...
                    ftext += "\ncukup forward saja pesan ini ke @SanzyChats"
                    ftext += "\n================================\n\n"
        ...
        if Sanzy:
            if not disable_edited:
                Sanzy.add_event_handler(wrapper, events.MessageEdited(**args))
            Sanzy.add_event_handler(wrapper, events.NewMessage(**args))
        return wrapper
