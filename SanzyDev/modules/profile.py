...
@sanzy_cmd(pattern="name", allow_sudo=False)
...
@sanzy_cmd(pattern="setpfp$", allow_sudo=False)
...
@sanzy_cmd(pattern="setbio (.*)", allow_sudo=False)
...
@sanzy_cmd(pattern="username (.*)", allow_sudo=False)
...
async def count(event):
    ...
    dialogs = await sanzy.get_dialogs(limit=None, ignore_migrated=True)
    for d in dialogs:
...
@sanzy_cmd(pattern="delpfp", allow_sudo=False)
