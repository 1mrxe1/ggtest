...
from SanzyDev import CMD_HELP, LOGS, sanzy
from SanzyDev.sanzy import _format, sanzy_cmd, edit_delete, edit_or_reply
from SanzyDev.sanzy.tools import media_type
from SanzyDev.database.log import approve_log, disapprove_log, is_approved_log
from SanzyDev.database.variable import get_var, set_var
...
@sanzy.on(events.NewMessage(incoming=True, func=lambda e: e.is_private))
@sanzy.on(events.MessageEdited(incoming=True, func=lambda e: e.is_private))
...
@sanzy.on(events.NewMessage(incoming=True, func=lambda e: e.mentioned))
@sanzy.on(events.MessageEdited(incoming=True, func=lambda e: e.mentioned))
...
@sanzy_cmd(pattern="pmlog (on|off)$")
...
@sanzy_cmd(pattern="gruplog (on|off)$")
