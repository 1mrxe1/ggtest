...
async def ANTI_SPAMBOTS(welcm):
    ...
    try:
        ...
        if welcm.user_joined or welcm.user_added:
            ...
            async for admin in Sanzy.iter_participants(
            ...
            for user_id in users:
                async for message in Sanzy.iter_messages(
            ...
            if spambot:
                ...
                elif var.ANTI_SPAMBOT_SHOUT:
                    await welcm.reply(
                        f"**Alert!** [{check_user.first_name}](tg://user?id={check_user.id}) is a known spammer and is {reason}.\n**Ban is strongly recommended.**"
                    )
                    kicked = False
                    reported = True
                if var.BOTLOG_CHATID and (kicked or reported):
