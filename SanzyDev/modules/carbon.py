...
from SanzyDev.sanzy.misc import Carbon
...
async def crbn(event):
    ...
    xx = await Carbon(code=code, file_name="carbon_sanzy", backgroundColor=col)
    await xxxx.delete()
    await event.reply(
