...
from SanzyDev.events import sanzy_cmd
from SanzyDev.sanzy import edit_delete, get_user_from_event
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"(\w+)say (.*)"))
async def _(cowmsg):
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"coinflip (.*)"))
async def _(event):
...
@Sanzy.on(sanzy_cmd(pattern=r"slap(?: |$)(.*)", outgoing=True))
async def _(event):
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"tt(?: |$)(.*)"))
async def _(e):
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"pantat(?: |$)(.*)"))
async def _(e):
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"(yes|no|maybe|decide)$"))
async def _(event):
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r";_;$"))
async def _(idk):
    t = ";_;"
    for _ in range(10):
        t = t[:-1] + "_;"
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"fp$"))
async def _(palm):
    """Facepalm  🤦‍♂"""
    await palm.edit("🤦‍♂")


@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"cry$"))
async def _(e):
    """y u du dis, i cry everytime !!"""
    await e.edit(choice(CRI))


@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"insult$"))
async def _(e):
    """I make you cry !!"""
    await e.edit(choice(INSULT_STRINGS))


@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"cp(?: |$)(.*)"))
async def _(cp_e):
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"vapor(?: |$)(.*)"))
async def _(vpr):
    """Vaporize everything!"""
    reply_text = []
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"str(?: |$)(.*)"))
async def _(stret):
    """Stretch it."""
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"zal(?: |$)(.*)"))
async def _(zgfy):
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"hi$"))
async def _(hello):
    """Greet everyone!"""
    await hello.edit(choice(HELLOSTR))


@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"owo(?: |$)(.*)"))
async def _(owo):
    """UwU"""
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"react$"))
async def _(react):
    """Make your userbot react to everything."""
    await react.edit(choice(FACEREACTS))


@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"shg$"))
async def _(shg):
    r"""¯\_(ツ)_/¯"""
    await shg.edit(choice(SHGS))


@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"chase$"))
async def _(chase):
    """Lari bro lari, aku akan segera menangkapmu !!"""
    await chase.edit(choice(CHASE_STR))


@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"run$"))
async def _(run):
    """Lari, lari, LARIII!"""
    await run.edit(choice(RUNS_STR))


@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"metoo$"))
async def _(hahayes):
    """Haha yes"""
    await hahayes.edit(choice(METOOSTR))


@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"oem$"))
async def _(e):
    t = "Oem"
    for _ in range(16):
        t = t[:-1] + "em"
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"10iq$"))
async def _(e):
    await e.edit("♿")


@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"fuck$"))
async def _(e):
    await e.edit(".                       /¯ )")
    await e.edit(".                       /¯ )\n                      /¯  /")
    await e.edit(
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"moon$"))
async def _(moone):
    deq = deque(list("🌗🌘🌑🌒🌓🌔🌕🌖"))
    try:
        for _ in range(32):
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"bunga$"))
async def _(event):
    deq = deque(list("🌼🌻🌺🌹🌸🌷"))
    try:
        for _ in range(35):
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"waktu$"))
async def _(event):
    deq = deque(list("🎑🌄🌅🌇🌆🌃🌌"))
    try:
        for _ in range(100):
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"buah$"))
async def _(event):
    deq = deque(list("🍉🍓🍇🍎🍍🍐🍌"))
    try:
        for _ in range(35):
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"clock$"))
async def _(event):
    deq = deque(list("🕙🕘🕗🕖🕕🕔🕓🕒🕑🕐🕛"))
    try:
        for _ in range(32):
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"rain$"))
async def _(event):
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"boxes$"))
async def _(event):
    deq = deque(list("🟥🟧🟨🟩🟦🟪🟫⬛⬜"))
    try:
        for _ in range(32):
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"hmm$"))
async def _(event):
    deq = deque(list("🤔🧐🤔🧐🤔🧐"))
    try:
        for _ in range(32):
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"haha$"))
async def _(event):
    deq = deque(list("😂🤣😂🤣😂🤣"))
    try:
        for _ in range(32):
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"operations$"))
async def _(event):
    deq = deque(list("!@#$%^&*()_+="))
    try:
        for _ in range(32):
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"love$"))
async def _(event):
    deq = deque(list("❤️🧡💛💚💙💜🖤💕💞💓💗💖💘💝"))
    try:
        for _ in range(32):
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"earth$"))
async def _(event):
    deq = deque(list("🌏🌍🌎🌎🌍🌏🌍🌎"))
    try:
        for _ in range(32):
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"hati$"))
async def _(event):
    deq = deque(list("🖤💜💙💚💛🧡❤️🤍"))
    try:
        for _ in range(32):
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=".monyet$"))
async def _(event):
    deq = deque(list("🙈🙉🙈🙉🙈🙉🙈🙉"))
    try:
        for _ in range(32):
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=".emo$"))
async def _(event):
    deq = deque(list("🙂😁😄😃😂🤣😭🐵🙊🙉🙈"))
    try:
        for _ in range(32):
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"mock(?: |$)(.*)"))
async def _(mock):
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"weeb(?: |$)(.*)"))
async def _(e):
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"clap(?: |$)(.*)"))
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"teksbiru$"))
async def _(bt_e):
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"f (.*)"))
async def _(event):
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"lfy (.*)"))
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"sayhi$"))
async def _(e):
    await e.edit(
        "\n💰💰💰💰💰💰💰💰💰💰💰💰"
        "\n💰🔷💰💰💰🔷💰💰🔷🔷🔷💰"
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"scam(?:\s|$)([\s\S]*)"))
async def _(event):
    options = [
        "typing",
        "contact",
...
@Sanzy.on(sanzy_cmd(pattern=r"type(?: |$)(.*)", outgoing=True))
async def _(typew):
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"fail$"))
async def _(e):
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"lol$"))
async def _(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit(
            "`\n╱┏┓╱╱╱╭━━━╮┏┓╱╱╱╱ `"
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"rock$"))
async def _(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit(
            "`\n┈╭╮┈┈┈┈┈┈┈┈┈┈┈┈ `"
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"lool$"))
async def _(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit(
            "`\n╭╭━━━╮╮┈┈┈┈┈┈┈┈┈┈\n┈┃╭━━╯┈┈┈┈▕╲▂▂╱▏┈\n┈┃┃╱▔▔▔▔▔▔▔▏╱▋▋╮┈`"
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"stfu$"))
async def _(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit(
            "`\n██████████████████████████████`"
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"gtfo$"))
async def _(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit(
            "`\n███████████████████████████████ `"
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"nih$"))
async def _(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit(
            "`\n(\\_/)`"
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"fag$"))
async def _(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit(
            "`\n█████████`"
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"tai$"))
async def _(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("\n{\\__/}" "\n(●_●)" "\n( >💩 Mau Tai Ku?")


@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"paw$"))
async def _(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("`(=ↀωↀ=)")


@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"tf$"))
async def _(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("(̿▀̿ ̿Ĺ̯̿̿▀̿ ̿)̄  ")


@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"gey$"))
async def _(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit(
            "`\n┈┈┈╭━━━━━╮┈┈┈┈┈\n┈┈┈┃┊┊┊┊┊┃┈┈┈┈┈`"
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"gay$"))
async def _(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit(
            "`\n┈┈┈╭━━━━━╮┈┈┈┈┈\n┈┈┈┃┊┊┊┊┊┃┈┈┈┈┈`"
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"bot$"))
async def _(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit(
            "` \n   ╲╲╭━━━━╮ \n╭╮┃▆┈┈▆┃╭╮ \n┃╰┫▽▽▽┣╯┃ \n╰━┫△△△┣━╯`"
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"hey$"))
async def hey(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit(
            "\n┈┈┈╱▔▔▔▔╲┈╭━━━━━\n┈┈▕▂▂▂▂▂▂▏┃HEY!┊😀`"
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"nou$"))
async def _(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit(
            "`\n┈╭╮╭╮\n┈┃┃┃┃\n╭┻┗┻┗╮`"
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"iwi(?: |$)(.*)"))
async def _(siwis):
    """IwI"""
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"koc$"))
async def _(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("8✊===D")
        await e.edit("8=✊==D")
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=".gas$"))
async def _(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"(?:penis|dick)\s?(.)?"))
async def _(e):
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"(?:kontol)\s?(.)?"))
async def _(e):
    emoji = e.pattern_match.group(1)
    kontl = GAMBAR_KONTL
    if emoji:
...
@Sanzy.on(sanzy_cmd(outgoing=True, pattern=r"skull$"))
async def _(e):
    emoji = e.pattern_match.group(1)
