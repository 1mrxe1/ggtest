# © Copyright 2021 sanzy-Userbot LLC Company.
...
@sanzy_cmd(pattern=r"hacking(?: |$)(.*)")
async def _(kontol):
    sanzy = await edit_or_reply(kontol, "Installing.")
    await sanzy.edit("Installing..")
    await sanzy.edit("Installing...")
    await sanzy.edit("Installing....")
    sleep(3)
    await sanzy.edit("`Installing Files To Hacked Private Server...`")
    sleep(3)
    await sanzy.edit("`Target Selected.`")
    sleep(4)
    await sanzy.edit("`Installing... 0%\n▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ `")
    sleep(3)
    await sanzy.edit("`Installing... 4%\n█▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ `")
    sleep(2)
    await sanzy.edit("`Installing... 8%\n██▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ `")
    sleep(3)
    await sanzy.edit("`lnstallig... 20%\n█████▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ `")
    sleep(2)
    await sanzy.edit("`Installing... 36%\n█████████▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ `")
    sleep(3)
    await sanzy.edit("`Installing... 52%\n█████████████▒▒▒▒▒▒▒▒▒▒▒▒ `")
    sleep(2)
    await sanzy.edit("`Installing... 84%\n█████████████████████▒▒▒▒ `")
    sleep(2)
    await sanzy.edit("`Installing... 100%\n████████Installed██████████ `")
    sleep(2)
    await sanzy.edit("`Target files Uploading...\n\nDirecting To Remote  server to hack..`")
    sleep(3)
    await sanzy.edit("Connecting nd getting combined token from my.telegram.org ")
    sleep(3)
    await sanzy.edit("`root@anon:~#` ")
    sleep(2)
    await sanzy.edit("`root@anon:~# ls`")
    sleep(3)
    await sanzy.edit("`root@anon:~# ls\n\n  usr  ghost  codes  \n\nroot@aono:~#`")
    sleep(3)
    await sanzy.edit("`root@anon:~# ls\n\n  usr  ghost  codes  \n\nroot@aono:~# # S`")
