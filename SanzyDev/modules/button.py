...
from SanzyDev import CMD_HELP, bot
from SanzyDev.sanzy import sanzy_cmd, edit_delete, reply_id
...
@sanzy_cmd(pattern="cbutton(?:\\s|$)([\\s\\S]*)")
async def _(event):
...
@sanzy_cmd(pattern="ibutton(?:\\s|$)([\\s\\S]*)")
async def _(event):
    ...
    BOT_USERNAME = sanzyUBOT.username
...
CMD_HELP.update(
    {
        ...
        \n  •  **Examples : **`{cmd}cbutton test [google]<buttonurl:https://www.google.com> [Channel]<buttonurl:https://t.me/Sanzy_updatebot:same> [Support]<buttonurl:https://t.me/SanzyChats>`\
        ...
        \n  •  **Examples : **`{cmd}ibutton test [google]<buttonurl:https://www.google.com> [Channel]<buttonurl:https://t.me/Sanzy_updatebot:same> [Support]<buttonurl:https://t.me/SanzyChats>`\
    "
    }
)
