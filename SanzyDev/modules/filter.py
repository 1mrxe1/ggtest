...
from SanzyDev.database.filters import add_filter, del_filter, get_all_filters, update_filter
from SanzyDev.events import Sanzy_cmd, register
...
@Sanzy.on(Sanzy_cmd(outgoing=True, pattern=r"filter (.*)"))
...
@Sanzy.on(Sanzy_cmd(outgoing=True, pattern=r"stop (.*)"))
...
@Sanzy.on(Sanzy_cmd(outgoing=True, pattern=r"delfilterbot (.*)"))
...
@Sanzy.on(Sanzy_cmd(outgoing=True, pattern=r"filters$"))
