...
@sanzy_cmd(pattern="(?:alive|yinson)\\s?(.)?")
async def amireallyalive(alive):
    ...
    output = (
        f"**Tʜᴇ [Sanzy-Usᴇʀʙᴏᴛ](https://github.com/sanzydev/Sanzy-Userbot)**\n\n"
        f"**{alive_text}**\n\n"
        f"╭✠╼━━━━━━━━━━━━━━━✠╮\n"
