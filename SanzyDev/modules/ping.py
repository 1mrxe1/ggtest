...
from SanzyDev.sanzy import edit_or_reply, humanbytes, sanzy_cmd
...
@sanzy_cmd(pattern="ping$")
async def _(ping):
    uptime = await get_readable_time((time.time() - StartTime))
    start = datetime.now()
    sanzy = await edit_or_reply(ping, "**✧**")
    await sanzy.edit("**✧✧**")
    await sanzy.edit("**✧✧✧**")
    await sanzy.edit("**✧✧✧✧**")
    await sanzy.edit("**✧✧✧✧✧**")
