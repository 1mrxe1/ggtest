...
from SanzyDev.sanzy import sanzy_cmd, chataction, edit_or_reply, get_user_from_event
from SanzyDev.database.gban import add_gbanned, del_gbanned, cek_gbanned, get_gbanned
...
async def gban(event):
    ...
    if user.id == (await event.client.get_me()).id:
        ...
        return
    if user.id in DEVS:
        await gbun.edit("**Apakah Anda Gila ?.. Dia Adalah Developer sanzy-Userbot 🤪**")
        return
