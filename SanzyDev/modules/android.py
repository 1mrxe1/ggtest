...
@sanzy_cmd(pattern=r"codename(?: |)([\S]*)(?: |)([\s\S]*)")
...
async def download_api(dl):
    ...
    file_path = var.TEMP_DOWNLOAD_DIRECTORY + file_name
...
@sanzy_cmd(pattern=r"specs(?: |)([\S]*)(?: |)([\s\S]*)")
