...
from SanzyDev.sanzy import SanzyChanger, sanzy_cmd, eor, parse_pre
from SanzyDev.database.broadcast import (
    add_broadcast,
    cek_is_braodcast,
    del_broadcast,
)
...
async def catbroadcast_send(event):
    ...
    chats = SanzyChanger(cek_is_braodcast(keyword))
    if not chats:
...
async def catbroadcast_add(event):
    ...
    keyword = catinput_str.lower()
    check = SanzyChanger(cek_is_braodcast(keyword))
