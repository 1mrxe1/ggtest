...
from SanzyDev import Sanzy, LOGS
from SanzyDev.Sanzy.format import md_to_text, paste_message
...
async def is_admin(chat_id, user_id):
    req_jo = await Sanzy(GetParticipantRequest(channel=chat_id, user_id=user_id))
...
def post_to_telegraph(title, html_format_content):
    ...
    auth_name = "Sanzy-Userbot"
    auth_url = "https://github.com/sanzydev/Sanzy-Userbot"
